...
@include('alerts.success')
  ...
  <ul class="nav nav-tabs" role="tablist">
          <li class="nav-item"> <a class="nav-link active"  href="{{ url('listar-ventas') }}" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Ventas</span></a> </li>
      </ul>
    ...
    $('#mydatatable').DataTable({
        ...
        columns: [
            ...
            { data: null,  render: function ( data, type, row ) {
              ...
              if(data.realizada == "web"){
                return "<a href='#' data-toggle='modal' ><span class='label label-success'>"+data.realizada+"</span></a>" 
                }

              if(data.realizada == "local"){
                return "<a href='#' data-toggle='modal' ><span class='label label-warning'>"+data.realizada+"</span></a>" 
                }
